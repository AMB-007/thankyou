...
export default function App() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-start p-4 sm:p-6 relative overflow-hidden bg-gradient-to-br from-purple-900 via-gray-900 to-black">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-purple-900/20 pointer-events-none z-10" />
      <div className="relative z-20 w-full flex justify-center min-h-screen">
        <Routes>
